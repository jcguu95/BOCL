...
extern object cfun_package_nicknames(object maybe_package);
extern void set_package_name(object package, object string);
extern void set_package_nicknames(object package, object list);
